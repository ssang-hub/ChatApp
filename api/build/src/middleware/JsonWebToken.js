...
exports.refreshToken = exports.logout = exports.generateRefreshToken = exports.generateAccessToken = exports.deleteToken = exports.createNewToken = exports.authVerify = void 0;
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          refreshToken = req.body.token; //send error if there is no token or it's invalid
          if (refreshToken) {
            _context2.next = 3;
            break;
          }
        ...
        case 3:
          _context2.next = 5;
          return _refreshTokenModel["default"].findRefreshToken(refreshToken);
        case 5:
        ...
        case 9:
          ...
          // }
          _jsonwebtoken["default"].verify(refreshToken, process.env.JWT_SECRET_KEY, /*#__PURE__*/function () {
            var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(err, user) {
              var deleteResult, newAccessToken, newRefreshToken;
              return _regeneratorRuntime().wrap(function _callee$(_context) {
                while (1) switch (_context.prev = _context.next) {
                  case 0:
                    ...
                    console.log(user);
                    _context.next = 4;
                    return _refreshTokenModel["default"].findAndDeleteRefreshToken(refreshToken);
                  case 4:
                    deleteResult = _context.sent;
                    newAccessToken = generateAccessToken(user);
                    newRefreshToken = generateRefreshToken(user);
                    _context.next = 9;
                    return _refreshTokenModel["default"].createRefreshToken(newRefreshToken);
                  case 9:
                    res.status(200).json({
...
var generateAccessToken = function generateAccessToken(data) {
  return _jsonwebtoken["default"].sign(data, process.env.JWT_SECRET_KEY, {
    expiresIn: '30m'
  });
};
...
var logout = function logout(req, res) {
  ...
  _refreshTokenModel["default"] = (_refreshTokenModel["default"].filter(function (token) {
...
var authVerify = function authVerify(req, res, next) {
...
var deleteToken = function deleteToken(req, res) {
